  ...
  return (
    <div className="row">
      <div class="col-lg-2s col-md-2 col-sm-12 col-12 p-5">
        <a
          href="https://goo.gl/maps/pnKbNezjdGt8tnf49"
          target="_blank"
        ...
        <p className="contactText">
          ...
          Kooperatifler Mah. Yaşar Kemal Cad. No:29 <br/> <b>Yenişehir / Diyarbakır</b>
        </p>
      </div>
      <div class="col-lg-2s col-md-2 col-sm-12 col-12 p-5">
        <a
          href="tel: +905013300021"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <div class="col-lg-2s col-md-2 col-sm-12 col-12 p-5">
      <a href="https://wa.me/+905013300021" target="_blank">
      ...
      <div class="col-lg-2s col-md-2 col-sm-12 col-12 p-5">
        <a href="https://www.instagram.com/lavinyagoldendiyarbakir/" target="_blank">
          <img src={i5} className="contactIcons" title="Instagram"></img>
        </a>
        <p className="contactText">
        <span style={{color:"red"}}><b>Instagram:</b></span><br/>
          @lavinyagoldendiyarbakir
        </p>
      </div>
      <div class="col-lg-2s col-md-2 col-sm-12 col-12 p-5">
        <a
          href="https://www.facebook.com/lavinyagoldendiyarbakir"
          target="_blank"
        >
